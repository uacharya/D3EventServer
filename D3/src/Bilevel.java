...
public class Bilevel {
	...
	/**
	 * This method handles the incoming connection from d3 web page to the d3 server
	 * @param session started by a d3 webpage
	 */
	@OnOpen
	...
	/**
	 * This method responds to each or all of the open browsers based on the type of message sent from either one of them
	 * @param session specific to a connection from a browser running a d3 page
	 * @param message sent by either one of the browser or d3 page
	 */
	@OnMessage
	...
	/**
	 * This method sends event data to all the browsers that has open connection with the server
	 * @param message event data to send
	 */
	...
	/**
	 * This method creates and sends dimension data for each browser based on where the connection comes from
	 * @param session specific to a connection from a browser running a d3 page
	 * @param IPAddress of the browser which is requesting for dimension data
	 * @param monitorLocation screenX coordinate of the browser which is requesting dimension data
	 */
	...
	/**
	 * This method creates and returns dimension data based on the connection Ip address and the monitor screenX location
	 * @param IPAddress of the browser which is requesting for dimension data
	 * @param monitorLocation screenX coordinate of the browser which is requesting dimension data
	...
	/**
	 * This method prints stack trace if some kind of unwanted error occurred while running server
